...
Route::resource('/api/v1/admin/chains', '\App\Http\Controllers\Api\V1\admin\ChainController');

Route::resource('/api/v1/admin/real-wallet', '\App\Http\Controllers\Api\V1\admin\RealWalletController');

Route::resource('/api/v1/admin/token', '\App\Http\Controllers\Api\V1\admin\TokenController');
