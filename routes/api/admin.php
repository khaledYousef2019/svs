...
Route::group(['prefix'=>'v1/admin','namespace'=>'Api\V1\admin','middleware'=> ['auth:api','admin','default_lang']],function () {
    ...
    Route::get('test', 'DashboardController@adminTest')->name('adminTest');
    ...
    Route::post('change-password-save', 'DashboardController@changePasswordSave')->name('changePasswordSave');
    ...
    Route::post('user-add', 'UserController@UserAddEdit')->name('admin.UserAddEdit');
    ...
    Route::post('verification-reject', 'UserController@verificationReject')->name('verificationReject');
    ...
    Route::get('buy-coin-order', 'CoinController@adminCoinOrder')->name('adminPendingCoinOrder');
    ...
    Route::post('check-wallet-address', 'SettingsController@check_wallet_address')->name('check_wallet_address');
    ...
    Route::get('membership-settings', 'ClubController@adminMembershipSettings')->name('adminMembershipSettings');
