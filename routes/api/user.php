...
Route::group(['prefix'=>'v1','namespace' => 'Api'], function () {
    ...
    Route::post('send-otp-mail','AuthController@resendOtp');
    Route::post('forgot-password','AuthController@sendResetCode');
    Route::post('reset-password','AuthController@resetPassword');
});

Route::group(['prefix'=>'v1/user','namespace'=>'Api\V1\user','middleware'=> ['auth:api','user', 'lang']],function () {
...
Route::group(['prefix'=>'v1/user','namespace'=>'Api\V1\user','middleware'=> ['auth:api','user', 'lang']], function () {
    Route::post('/upload-profile-image', 'ProfileController@uploadProfileImage')->name('uploadProfileImage');
    Route::post('/user-profile-update', 'ProfileController@userProfileUpdate')->name('userProfileUpdate');
