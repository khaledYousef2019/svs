...
class TransactionService
{
    ...
    public function send($wallet, $address, $amount, $is_admin = false, $pendingTransaction = null, $authId = null, $message =null, $tempWithdrawId = null)
    {
        ...
        $wallet = Wallet::join('coins', 'coins.id', '=', 'wallets.coin_id')
            ->where(['wallets.id' => $wallet, 'wallets.user_id' => $authId ])
...
//    }
    ...
    public function depositTransactionHistories($user_id = null, $status = null, $wallet_id = null, $address_type = null, $transaction_id = null)
    {
        ...
        $histories->orderBy('deposite_transactions.id','desc');
        return $histories;
    }
    ...
    public function withdrawTransactionHistories($user_id = null, $status = null, $wallet_id = null, $address_type = null, $transaction_id = null)
    {
        ...
        if ( !empty($user_id) )
            $histories = $histories->where('wallets.user_id', $user_id);
        $histories->orderBy('withdraw_histories.id','desc');
        return $histories;
    }
    ...
    public function kycValidationCheck($userId)
    {
        ...
        if (isset($settings['kyc_enable_for_withdrawal']) && ($settings['kyc_enable_for_withdrawal'] == STATUS_ACTIVE)) {
            if (isset($settings['kyc_nid_enable_for_withdrawal']) && ($settings['kyc_nid_enable_for_withdrawal'] == STATUS_ACTIVE)) {
            ...
            if (isset($settings['kyc_passport_enable_for_withdrawal']) && ($settings['kyc_passport_enable_for_withdrawal'] == STATUS_ACTIVE)) {
            ...
            if (isset($settings['kyc_driving_enable_for_withdrawal']) && ($settings['kyc_driving_enable_for_withdrawal'] == STATUS_ACTIVE)) {
