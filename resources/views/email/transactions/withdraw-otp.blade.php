...
<p><b>{{$data->trx->otp}}</b></p>
<p style="font-weight: bolder;">{{$data->trx->code}}</p>
<p>This verification code will be valid for 30 minutes.</p>
<p>Please do not share your code with any one.</p>
